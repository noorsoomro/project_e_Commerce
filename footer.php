    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <h3>Useful Links</h3>
                <ul class="menu-list">
                    <li><a href="index.php" href="<?php echo $hostname; ?>">Home</a></li>
            ...
            <div class="col-md-12">
                <span><?php echo $footer[0]['footer_text'] ?> | Created by <a href="https://cah-lrk@aptech-education.com.pk" target="_blank">Aptech Larkana Students</a></span>
            </div>
        </div>
    </div>
</div>
